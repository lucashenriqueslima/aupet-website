...
<script src="<?php echo $this->main_template ?>plugins/gallery/photoswipe/photoswipe.js"></script>
<script src="<?php echo $this->main_template ?>plugins/gallery/photoswipe/photoswipe-ui-default.js"></script>
...
<script>
    ...
    pswpcss.setAttribute('href', '<?php echo $this->main_template ?>plugins/gallery/photoswipe/photoswipe.css');
    document.getElementsByTagName("head")[0].appendChild(pswpcss);

    pswpcss = document.createElement('link');
    pswpcss.setAttribute('rel', 'stylesheet');
    pswpcss.setAttribute('type', 'text/css');
    pswpcss.setAttribute('href', '<?php echo $this->main_template ?>plugins/gallery/photoswipe/default-skin/default-skin.css');
    document.getElementsByTagName("head")[0].appendChild(pswpcss);
