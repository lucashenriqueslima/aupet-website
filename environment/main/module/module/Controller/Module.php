...
class __classe__ extends Bootstrap {
    ...
    function __construct() {
        ...
        $this->table = "hbrd_main_modulos";
        $this->module_title = "Módulos";
    ...
    private function delAction() {
        ...
        try {
            ...
            $this->inserirRelatorio("Removeu o módulo [{$id}]");
    ...
    private function indexAction() {
        ...
        $this->list = $this->DB_fetch_array("SELECT * FROM hbrd_main_modulos");
    ...
    private function saveAction() {
        ...
        try {
            if ($formulario->id == "") {
                ...
                $this->inserirRelatorio("Registrou um módulo [{$id}]");
                ...
                $this->inserirRelatorio("Atualizou um módulo [{$formulario->id}]");
